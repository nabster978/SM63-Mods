# MushROM: Super Mario 63 Practice Mod

**MushROM** is a dedicated practice mod for Super Mario 63
...
## Documentation
For a complete list of features and syntax, refer to the following documents provided with the mod:

* **Command Reference (`help.md`):** Contains the full list of available commands along with their specific arguments, aliases, and usage instructions.
* **Warp Directory (`warpalias.md`):** Provides a comprehensive list of all room codes and their corresponding aliases
